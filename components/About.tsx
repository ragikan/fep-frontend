...
<div className={styles.productGrid}>
  ...
  <div className={styles.productContainer}>
        ...
        <FontAwesomeIcon icon={faRobot} className={styles.productImage}/>
          ...
          <p className={styles.productDescription}>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quos animi fugit rerum architecto nihil maiores distinctio explicabo earum harum. Dolores esse, deserunt eum quas nisi molestiae optio ex voluptate blanditiis?</p>
          </div>
