    ...
    <>
        <div className="rounded overflow-hidden shadow-lg">
            ...
            <div className="px-6 py-4">
                ...
                This project involves designing a smart home automation system using IoT technology. It integrates various home devices for centralized control via a mobile app. The system aims to enhance convenience, security, and energy efficiency. Key components include microcontrollers, sensors, and communication modules.
                </p>
            </div>
            <div className="px-6 py-4 flex flex-row items-center">
            <button onClick={()=>{setModal(true)}} type="button" className="focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Chat</button>
            </div>
            </div>
            {checkmodalstatus?
            <>
            <Dialog className="relative z-10" open={checkmodalstatus} onClose={()=>{setModal(false)}}>
      <DialogBackdrop
        transition
