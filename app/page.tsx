...
import {
  AppBar, Toolbar, Typography, Button, Box, Container, IconButton, Drawer, List, ListItem, ListItemText, ListItemIcon,
  Accordion, AccordionSummary, AccordionDetails, TextField, Card, CardContent, CardActions
} from '@mui/material';
...
const Page = () => {
  ...
  const navLinks = (
    <>
      <Button href="#home" color="inherit"><HomeIcon /> HOME</Button>
      <Button href="#aboutus" color="inherit"><InfoIcon /> ABOUT US</Button>
      <Button href="#faq" color="inherit"><HelpIcon /> F.A.Q</Button>
      <Button href="#team" color="inherit"><PeopleIcon /> TEAM</Button>
      <Button href="#testimonials" color="inherit"><StarIcon /> TESTIMONIALS</Button>
      <Button href="#contactus" color="inherit"><ContactMailIcon /> CONTACT US</Button>
    </>
  );
  ...
  return (
    <div className={styles.root}>
      ...
      <Drawer anchor="right" open={drawerOpen} onClose={toggleDrawer(false)}>
        <Box className={styles.drawerContent} role="presentation" onClick={toggleDrawer(false)} onKeyDown={toggleDrawer(false)}>
      ...
      <Container className={styles.content}>
        <div id="aboutus" className={styles.section}>
          <Typography variant="h4" className={styles.sectionHeading}>About Us</Typography>
          <About />
        ...
        <div id="faq" className={styles.section}>
          <Typography variant="h4" className={styles.sectionHeading}>F.A.Q</Typography>
        ...
        <div id="team" className={styles.section}>
          <Typography variant="h4" className={styles.sectionHeading}>Team</Typography>
          <Team />
        </div>
        <div id="testimonials" className={styles.section}>
          <Typography variant="h4" className={styles.sectionHeading}>Testimonials</Typography>
          <Typography variant="body1" className={styles.sectionContent}>
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque nisl eros, pulvinar facilisis justo mollis, auctor consequat urna.
          </Typography>
        </div>
        <div id="contactus" className={styles.section}>
          <Typography variant="h4" className={styles.sectionHeading}>Contact Us</Typography>
          <Card className={styles.contactCard}>
            <CardContent>
              <TextField label="Name" variant="outlined" fullWidth margin="normal" className={styles.textField} />
              <TextField label="Email" variant="outlined" fullWidth margin="normal" className={styles.textField} />
              <TextField label="Subject" variant="outlined" fullWidth margin="normal" className={styles.textField} />
              <TextField
                label="Message"
                variant="outlined"
                fullWidth
